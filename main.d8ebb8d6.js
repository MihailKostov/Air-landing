...
function createSlider(slider) {
  var list = slider.querySelector('.slider__gallery');
  var prev = slider.querySelector('#arrow-left');
  var next = slider.querySelector('#arrow-right');
  ...
  function moveTo(newPosition) {
    ...
    list.style.transform = "translateX(".concat(-position * 100, "%)");
  }
  ...
  function normalizePozition(newPosition) {
    var finalPositions = newPosition % count;
